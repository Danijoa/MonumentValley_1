...
// 현재 큐브 번호에서 클릭한 큐브 번호로 가는 길 cubeConnectionGraph 사용해서 Dijkstra or BFS로 길찾기
// 찾은 큐브 번호에 해당하는 GameObject 찾아서 저장하기

// 차례대로 GameObject의 transform 으로 회전하고 이동하고 <- 이거 아직 안함!!!!!!!!!! 순간이동함
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(1))
        {
            ...
            if(curWalkableCubeLabel == curPlayerCubeLabel)
            {
                ...
                {
                    Vector3 nextCubePos = pathCube[i].transform.position;
